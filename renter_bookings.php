...
$bookings_sql = "SELECT b.*, p.title, p.location, p.photos, p.price, u.userID, u.name as rentee_name, u.phone_no as rentee_phone 
                FROM Booking b 
                ...
                <?php while ($booking = mysqli_fetch_assoc($result)): ?>
                    <div class="booking-card">
                        ...
                        <div class="booking-details">
                            ...
                            <p><strong>Phone:</strong> <?php echo htmlspecialchars($booking['rentee_phone']); ?> 
                                <a href="rentee_details.php?userID=<?php echo urlencode($booking['userID']); ?>" class="dropbtn1" style="font-size: 0.8rem; padding: 0.2rem 0.5rem; margin-left: 0.5rem;">View Details</a>
                            </p>
